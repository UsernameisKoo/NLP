...
│   └── Validation.xlsx
├── models/
│   ├── Original_CNN_BiLSTM_Attention.ipynb    # 감정 분석 모델 Ver1
│   └── Proposal_CNN_BiLSTM_Attention.ipynb    # 감정 분석 모델 Ver2
├── generation/
...
|담당자|역할|
|---|---|
|UsernameisKoo|감정 분류 모델 구현, 데이터 전처리, 성능 평가|
|r1nn-dev|문장 생성 모델 구현, 클로징 멘트 데이터셋 구성|
